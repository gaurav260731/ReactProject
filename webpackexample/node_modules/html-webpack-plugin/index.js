...
const vm = require('vm');
const fs = require('fs');
const _ = require('html-webpack-plugin/node_modules/lodash');
const path = require('path');
const childCompiler = require('html-webpack-plugin/lib/compiler');
    ...
    return Promise.resolve()
      ...
      .then(html => {
        if (self.options.minify) {
          const minify = require('html-webpack-plugin/node_modules/html-minifier').minify;
